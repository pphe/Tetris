...
public class Board extends Observable
{
     ...
     * This is used to prevent the Board from notifying observers for each
     * incremental down movement in the drop.
     */
     ...
     * 
     * @param theWidth
     *        Width of the Tetris game board.
     * @param theHeight
     *        Height of the Tetris game board.
     */
    public Board(final int theWidth, final int theHeight)
    {
        ...
        /*
         * myNextPiece and myCurrentPiece are initialized by the newGame()
         * method.
         */
    }
     ...
     * 
     * @param thePieces
     *        the List of non random TetrisPieces.
     */
     ...
     * tries to move into an illegal state. Clear full lines.
     */
    public void down()
    {
        ...
        if (myCurrentPiece != null)
        {
            ...
            else
            {
                ...
                final Point[] offsets = WallKick.getWallKicks(cwPiece.getTetrisPiece(), 
                        myCurrentPiece.getRotation(), cwPiece.getRotation());
        ...
        if (myCurrentPiece != null)
        {
            ...
            else
            {
                ...
                final Point[] offsets = WallKick.getWallKicks(ccwPiece.getTetrisPiece(), 
                        myCurrentPiece.getRotation(), ccwPiece.getRotation());
                for (final Point p : offsets)
                {
     ...
     * 
     * @param theMovedPiece
     *        the position to attempt to shift the current piece
     ...
     * frozen blocks.
     * 
     * @param theFrozenBlocks
     *        Board to set the piece on.
     * @param thePiece
     *        Piece to set on the board.
     */
     ...
     * 
     * @param theBoard
     *        Board to set the point on.
     * @param thePoint
     *        Board point.
     * @param theBlock
     *        Block to set at board point.
     */
     ...
     * 
     * @param theTest
     *        movable TetrisPiece to test for collision.
    ...
    /**
     * A class to describe the board data to registered Observers. The board
     * data includes the current piece and the frozen blocks.
     */
