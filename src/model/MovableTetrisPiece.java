...
public final class MovableTetrisPiece
{
    ...
    /**
     * Constructs a MovablTetrisPiece using the specified type and position; the
     * initial rotation is set to the default zero (NONE) Rotation.
     * 
     * @param theTetrisPiece
     *        the type of TetrisPiece.
     * @param thePosition
    ...
    /**
     * Constructs a MovablTetrisPiece using the specified type, position, and
     * initial rotation.
     * 
     * @param theTetrisPiece
     *        the type of TetrisPiece.
     ...
     *        the position on the Board.
     * @param theRotation
     *        the initial angle of the TetrisPiece.
     */
    public MovableTetrisPiece(final TetrisPiece theTetrisPiece, final Point thePosition, 
    ...
    /**
     * Returns a new MovableTetrisPiece of the current piece type and same
     * Rotation at the specified location.
     * 
     * @param thePosition
     *        the location for the returned MovableTetrisPiece
     ...
     * 
     * @param thePoint
     *        the point to transform the points around.
