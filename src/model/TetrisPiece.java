...
public enum TetrisPiece
{
    ...
    /** The 'O' TetrisPiece. */
    O(3, 2, Block.O, new Point(1, 2), new Point(2, 2), new Point(1, 1), new Point(2, 1)),
     ...
     * 
     * @param theWidth
     *        width of the TetrisPiece.
     * @param theHeight
     *        height of the TetrisPiece.
     * @param theBlock
     *        Block type of the TetrisPiece.
     * @param thePoints
     *        the initial position of the blocks of the TetrisPiece.
     */
    TetrisPiece(final int theWidth, final int theHeight, final Block theBlock, 
